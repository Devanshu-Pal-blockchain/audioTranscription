...
class Todo(BaseModel):
    ...
    assigned_to: str = Field(default="Unassigned", description="Full name of the person assigned")
    designation: str = Field(default="Team Member", description="Job title/designation of the assigned person")
