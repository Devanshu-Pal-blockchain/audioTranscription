...
from routes import quarter, rock, task, user, auth, upload, csv_routes, todo, issue, recording, chatbot, company
import logging
app = FastAPI(
...
app.include_router(upload.router, prefix="/facilitator", tags=["upload"])
